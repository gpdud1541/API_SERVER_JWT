...
//                .(Collections.singletonList("ROLE_USER")) // 최초 가입시 USER 로 설정
                .build()).getId();
    }
    ...
    public String login(@RequestBody Map<String, String> user) {
        ...
        return jwtTokenProvider.createToken(member.getAccount(), null);
    }


    @PostMapping("/authority")
    public ResponseEntity<JSONObject> getSerialnumber(@RequestBody String account){
